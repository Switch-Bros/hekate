...
static void _show_errors(int sd_error)
{
	...
	{
	case SD_MOUNT_ERROR:
		WPRINTF("SD-Karte konnte nicht initialisiert oder eingebunden werden!\n");
		goto error_occured;
	case SD_FILE_ERROR:
		WPRINTF("GUI Ressourcen konnten nicht geldaden werden!\nres.pak nicht gefunden oder kaputt.\n");
		goto error_occured;
	case SD_NO_ERROR:
	default:
		break;
