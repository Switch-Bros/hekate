...
static lv_res_t _create_mbox_cal0(lv_obj_t *btn)
{
	...
	s_printf(txt_buf + strlen(txt_buf), "#FF8000 SHA256-Hash-Uebereinstimmung:# %s", valid_cal0 ? "Durchgelaufen" : "Fehlgeschlagen");
...
static lv_res_t _create_window_fuses_info_status(lv_obj_t *btn)
{
	...
	else
	{
		...
		case LPDDR4X_AULA_4GB_SAMSUNG_K4U6E3S4AB_MGCL:
			...
			strcpy(dram_man, "Samsung 1z 4GB #FF8000 Kontaktiere CTCaer!#");
			break;
