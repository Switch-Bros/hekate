 ...
 */
	...
	case 6:
		...
		break;
	default:
		s_printf(txt_buf + strlen(txt_buf), " x Unb (%d)", (ram_density.chip0.rank0_ch0 & 0x3C) >> 2);
		break;
	}
	...
	case 6:
		...
		break;
	default:
		s_printf(txt_buf + strlen(txt_buf), " x Unb (%d)", (ram_density.chip1.rank0_ch0 & 0x3C) >> 2);
		break;
	}
	strcat(txt_buf, "\n\n");
